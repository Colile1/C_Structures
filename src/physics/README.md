...
| `FrameElement.cpp` | 6-DOF beam-column element stiffness and coordinate transformation. |
| `FrameSimulator.cpp` | Rigid-jointed frame solver: assembles global stiffness from `FrameElement`, applies BCs via static condensation, returns nodal displacements and reactions. |
